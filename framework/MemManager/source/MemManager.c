...
#endif
#if defined(MEM_TRACKING) || defined(MEM_STATISTICS_INTERNAL)
...
#ifdef MEM_STATISTICS
/*! *********************************************************************************
* \brief     Get memory pools details
*
* \param[in] pointer to get back memPools address
* \param[in] pointer to get back nenory pool size
*
********************************************************************************** */
void MEM_GetMemPools(pools_t **pMemPools, uint8_t *pPoolCount)
{
    *pMemPools = &memPools[0];
    *pPoolCount = (uint8_t)(sizeof(memPools)/sizeof(memPools[0]));
}
#endif /* MEM_STATISTICS */
