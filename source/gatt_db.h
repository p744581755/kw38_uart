...
PRIMARY_SERVICE_UUID128(service_wireless_uart, uuid_service_wireless_uart)
    CHARACTERISTIC_UUID128(char_uart_stream_rx, uuid_uart_stream_rx, (gGattCharPropWriteWithoutRsp_c))
        VALUE_UUID128_VARLEN(value_uart_stream_rx, uuid_uart_stream_rx, (gPermissionFlagWritable_c), gAttMaxWriteDataSize_d(gAttMaxMtu_c), 1, 0x00)
	CHARACTERISTIC_UUID128(char_uart_stream_tx, uuid_uart_stream_tx, (gGattCharPropNotify_c))
	    VALUE_UUID128_VARLEN(value_uart_stream_tx, uuid_uart_stream_tx, (gPermissionFlagReadable_c), gAttMaxWriteDataSize_d(gAttMaxMtu_c), 0)
		DESCRIPTOR_UUID128(desc_uart_stream_tx, gBleSig_CharPresFormatDescriptor_d, (gPermissionFlagReadable_c), 1, 0x01)
		CCCD(cccd_uart_stream_tx)
