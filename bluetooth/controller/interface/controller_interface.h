...
/*! *********************************************************************************
 * \brief  Returns for the provided handle (app adv handle), the corresponding advertising 
 *         handle as used by controller .
 * \param[in]  app_adv_handle: application advertising handle
 * \param[out] ll_adv_handle: controller advertising handle
 *
 * \return gBleSuccess_c, 
 *         gBleInvalidState_c: if ll_adv_handle is requested although no advertising has been yet configured,
 *         gBleInvalidParameter_c: if app_adv_handle is not in the correct range.
 *
 ********************************************************************************** */
bleResult_t Controller_GetLlAdvHandle(uint8_t app_adv_handle, uint8_t* ll_adv_handle);
